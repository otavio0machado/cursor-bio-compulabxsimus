-- Execute todo o conteúdo abaixo no Editor SQL do seu painel Supabase
-- Isso criará as tabelas necessárias para salvar o histórico de análises.
...
-- Políticas de acesso público (Ajuste para produção se necessário, mas ok para MVP interno)
